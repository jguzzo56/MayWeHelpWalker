...
def process_data(data):
    ...
    for angle in range(360):
        distance = data[angle]
        if distance > 0:
            if distance < 457.2 and (angle > 270 or angle < 90):
                ...
                if min_distance != temp_min:
                    min_angle = angle
            if distance > 457.2 and distance < 914.4 and (angle > 300 or angle < 60):
                # Set new max and min if necessary
                temp_max = max_distance
                max_distance = max(distance, max_distance)
                temp_min = min_distance
                ...
                if min_distance != temp_min:
                    min_angle = angle
            elif distance > 914.4 and distance < 1524 and (angle > 330 or angle < 30):
                # Set new max and min if necessary
                temp_max = max_distance
                max_distance = max(distance, max_distance)
                temp_min = min_distance
                ...
                if min_distance != temp_min:
                    min_angle = angle
            elif distance > 1524 and (angle > 270 or angle < 90):
                ...
                # Update the angle variables if a change in the max distance was detected
                if max_distance != temp_max:
                    max_angle = angle
                if min_distance != temp_min:
                    min_angle = angle
    # Closest distance (Less than 1 foot)
    if min_distance < 457.2 and min_distance > 0:
        cond = 3
    ...
    # Medium distance (1.5 foot to 3 feet)
    elif min_distance < 914.4 and min_distance > 457.2:
        cond = 4
    ...
    # Longest distance (3 feet to 5 feet)
    elif min_distance < 1524 and min_distance > 914.4:
        cond = 5
    ...
    # Test if max_distance is greater than 6 feet (Dropoff)
    elif max_distance > 1828.8:
        cond = 7
        
        # Set direction based on the angle
        if (max_angle > 350 and max_angle < 360) or (max_angle >= 0 and max_angle < 10):
            direction = 2
        else:
            direction = 5
...
def troubleshoot(cond,direction,min_distance,min_angle):
    ...
    if cond == 1:
        ...
        print("Lidar, Less than 1.5 foot: Condition = 3")
    elif cond == 4:
        print("Lidar, 1.5 to 3 feet: Condition = 4")
    elif cond == 5:
        print("Lidar, 3 to 5 feet: Condition = 5")
    elif cond == 6:
        print("Condition Wasn't Updated")
    elif cond == 7:
        print("Lidar, Greater than 6 feet: Condition = 7")
    else:
